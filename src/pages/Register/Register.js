...
const Register = () => {
     ...
     *
     * -- Mejora --
     * Considerar cambiar los tipos de datos de los campos a let o const debido a que
     * se están usando en una función y no en una variable. Esto podría causar errores
     * en el código.
     */
        ...
        <div className="container-form">
            <div className="ax-form-style1">
                ...
                <form className="ax-form__form" id="form" onSubmit={registration}>
                    <div className="ax-form__input">
                        <p> Nombres: </p>
                        <input name="name" id="nombre" type="text" value={cambio} onChange={handleChangeInput}
                               placeholder="Ingrese Nombre Completo" required/>
                    </div>
                    <div className="ax-form__input">
                        <p> Apellidos: </p>
                        <input name="surname" id="apellido" type="text" value={cambio2} onChange={handleChangeInput2}
                               placeholder="Ingrese Nombre Completo" required/>
                    </div>
                    <div className="ax-form__input">
                        <p> Correo Electr&oacute;nico: </p>
                        <input name="email" id="email" type="email"
                               placeholder="Introduce tu correo electrónico aquí..." required/>
                    </div>
                    <div className="ax-form__input">
                        <p> Contraseña: </p>
            ...
            <div>
                ...
                <form className="ax-form__form" id="form" onSubmit={registration}>
                    <div className="ax-form__input">
                        <p> Nombres: </p>
                        <input name="name" type="text" value={cambio} onChange={handleChangeInput}
                               placeholder="Ingrese Nombre Completo" required/>
                    </div>
                    <div className="ax-form__input">
                        <p> Apellidos: </p>
                        <input name="surname" type="text" value={cambio2} onChange={handleChangeInput2}
                               placeholder="Ingrese Nombre Completo" required/>
                    </div>
                    <div className="ax-form__input">
                        <p> Correo Electr&oacute;nico: </p>
                        <input name="email" type="email" placeholder="Introduce tu correo electrónico aquí..."
                               required/>
                    </div>
                    <div className="ax-form__input">
                        <p> Contraseña: </p>
